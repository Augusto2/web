	...
	<div class="variavel">
 	...
 	<table width="100%">
		...
		<tr>
 			...
 			<td><input type="submit" name="btnEnviar" value="Alterar" onliclck="validacliente()" onclick="return confirm('Tem certeza que deseja alterar os dados deste cliente?');"></td>

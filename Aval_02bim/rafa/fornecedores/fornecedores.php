    ...
    <header class="main-header">
      <nav class="navbar navbar-static-top">
		...
		<div class="variavel">
			...
			<p><a href="http://localhost/rafa/fornecedores/form-addfornecedores.php">Adicionar Fornecedor</a></p>
				...
				<table width="100%" border="1"> 
					...
					<tbody>
						...
						<tr>					
							...
							<td>
								<a href="http://localhost/rafa/fornecedores/form-editfornecedores.php?id=<?php echo $fornecedor['idFornecedor']?>">Editar</a>
								<a href="http://localhost/rafa/fornecedores/deletefornecedores.php?id=<?php echo $fornecedor['idFornecedor'] ?>" onclick="return confirm('Tem certeza que deseja excluir?');">Excluir</a>
							</td>
						</tr>
						<?php endwhile; ?>
 					</tbody>
          ...
          <div class="row text-left" id="tudo">
            ...
            <div class="col-md-3">
              <div class="footer-col">
                ...
                <a href="https://www.facebook.com/janete.silva.545?fref=ts"><i class="fa fa-5x fa-facebook-official pull-left"></i></a>
                <div class="footer-content">
                 <a href="https://github.com/MarceloMussel"><i class="fa fa-5x fa-fw fa-github"></i></a>
                </div>
              </div>
            </div>
            <div class="col-md-3">

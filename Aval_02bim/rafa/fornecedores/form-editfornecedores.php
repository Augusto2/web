...
<head>
    ...
    <header class="main-header">
      ...
      <div class="variavel">
		<form method ="post" name="formAltera" action ="http://localhost/rafa/fornecedores/editfornecedores.php" enctype="multipart/form-data">
			...
			<table width="100%">
 				...
 				<tr>
 					...
 					<td ><input type="text" class="calendarioF" name="txtData" id="data" value="<?php echo dateConvert($fornecedor['dataFundacao'])?>" class="calendarioF" readonly></td>
				</tr> 		
